   ...
   <table id="tblProductUpdate">
      ...
      <tbody>	
	      ...
	      <tr>
	         ...
	         <td style="width: 80%; text-align: left;">
	         	 <span>
	             	<input type="file" name="pdimage1" id="pdimage1" class="requiredInfo"  value="${pvo.pdimage1}" /><span class="error">제품이미지는 필수입력 사항입니다.</span>
	             </span>
	         </td> 
	      </tr>
	      <tr>
	      ...
	      <tr>
	         <td colspan="2" style="line-height: 30px; border-bottom: hidden;">
	            <span>
	            	<button type="button" id="btnRegister" style="margin: 20px 0px 20px 450px; border: none; border-radius: 5px; width: 100px; align:center; background-color: #BCA897; color:white;" onClick="goProductRegister();">수정하기</button>
	            	<button type="button" id="btnGoProductList" style="margin: 20px 0px 20px 450px; border: none; border-radius: 5px; width: 100px; align:center; background-color: #BCA897; color:white;">상품목록</button>
